...
module.exports = class dealContract {
  constructor() {
  ...
  // push transactions
  async sendTransaction(contractName, actionName, accountPrivateKey, params) {
    ...
    try {
      ...
      const data = smartContract.methods[actionName].apply(smartContract.methods, params).encodeABI(); // encode ABI
