...
struct miner {
   public:
	...
	PLATON_SERIALIZE(
	    miner,
	    (enclave_public_key)(reward_address)(sender))
};
...
struct miner_info {
	...
	PLATON_SERIALIZE(
	    miner_info,
	    (sender)(name)(peer_id)(country_code)(url))
};
...
CONTRACT dante_verify : public Contract {
   protected:
	...
	platon::db::Map<"proof_of_capacity"_n, string, proof_of_capacity> proof_of_capacity_map;  // proof_of_capacity table
	platon::db::Map<"miner_info"_n, Address, miner_info> miner_info_map;                      // miner_info map
   ...
   public:
	...
	ACTION void register_miner(const string &enclave_public_key, const Address &reward_address);
	...
	ACTION void submit_proof(const string &enclave_public_key, const string &enclave_timestamp, const u128 &enclave_capacity, const string &enclave_signature);
...
PLATON_DISPATCH(dante_verify, (init)(set_owner)(get_owner)(set_token_contract)(get_token_contract)(register_miner)(update_miner)(unregister_miner)(test)(submit_proof)(get_submit_proof)(get_miner)(get_total_capacity)(submit_miner_info)(get_miner_info))
}  // namespace hackathon